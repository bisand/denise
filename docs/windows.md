...
This is what it looks like when it works, from a Windows 11 ARM64 VM:

```text
design-time view — 200x120, no window, no site:
  ................................................................
  ................................................................
  ................................................................
  ................................................................
...
Nineteen rows over 120 pixels and sixty-four columns over 200, so each row is
about six pixels and each column about three. That is enough to check the layout
against the source rather than merely admire it:

| Rows | y | What `build` puts there |
|---|---|---|
| 4–5 | 25–32 | the `Label`, at `(12, 10, …, 22)` inside a card at `(8, 8)` — y 18–40 |
| 9–12 | 57–76 | the `TextInput`, at `(12, 38, …, 32)` — y 46–78 |
| 14–17 | 88–107 | the `Button`, at `(12, 78, 96, 30)` — y 86–116 |

The two lone `:` on row 12 are the field's left and right borders, at x≈21 and
x≈178 against a card spanning 8–192. The button's block runs columns 7–37, which
is x 21–115 against a button at x 20–116.

What the card's own fill does *not* do is show up: rows 1–3 are the same character
as the frame around them. That is the ramp, not a bug — ten steps over 0–255 is 25
luminance per character, and the dark theme's panel and surface sit closer
together than that.

One flat character throughout is the interesting failure: the panel painted its
background and stopped. The unit tests check the same picture by counting pixels
