...
| `TextInput` | Editing, a caret, selection by click, word, field or drag, a clipboard the application answers, and the only widget that animates by default |
...
group twenty-eight rows and say what each is without keeping a table of
