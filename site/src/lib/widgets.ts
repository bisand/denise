...
export const widgets: Widget[] = [
	...
	{ id: 'text-input', name: 'TextInput', group: 'Text and input', file: 'text_input.rs', blurb: 'A single-line editable text field.', more: 'Caret, placeholder, submit on Enter, dead keys, and selection: focus takes the whole field, a press places the caret, a second takes the word, a third takes everything. Copy, cut and paste go through the application, as the editor's do. Deliberately absent for now: undo and keyboard word motion.' },
