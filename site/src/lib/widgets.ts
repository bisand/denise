...
export const widgets: Widget[] = [
	...
	{ id: 'text-input', name: 'TextInput', group: 'Text and input', file: 'text_input.rs', blurb: 'A single-line editable text field.', more: 'Caret, placeholder, submit on Enter, dead keys, and selection: focus takes the whole field, a press places the caret, a second takes the word, a third takes everything. Ctrl or Option and an arrow move by word, and copy, cut and paste go through the application as the editor’s do. Deliberately absent for now: undo.' },
	{ id: 'text-area', name: 'TextArea', group: 'Text and input', file: 'text_area.rs', blurb: 'A multi-line text editor that edits through a document it does not own.', more: 'It asks only for the lines it is about to paint, so a file too big to load can sit behind it. Selection — a press, a word, a line — word motion, undo, paging, go-to-line, match highlighting, and bars down the side and along the bottom that are absent, not greyed, when the text fits.' },
