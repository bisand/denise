...
export const widgets: Widget[] = [
	...
	{ id: 'text-input', name: 'TextInput', group: 'Text and input', file: 'text_input.rs', blurb: 'A single-line editable text field.', more: 'Caret, placeholder, submit on Enter, dead keys. Deliberately absent for now: selection, clipboard and word motion.' },
	{ id: 'text-area', name: 'TextArea', group: 'Text and input', file: 'text_area.rs', blurb: 'A multi-line text editor that edits through a document it does not own.', more: 'It asks only for the lines it is about to paint, so a file too big to load can sit behind it. Selection, undo, paging, go-to-line and match highlighting.' },
